...
<head>
	...
	<title>Вардхман Хелскейр | Продукция</title>
			...
			<div class="row">
				<div class="col-sm-12">
					<ul class="nav-mnu hidden-xs">
						...
						<li class="nav-mnu__li"><a href="products.php" class="active">продукция</a></li>
	...
	<div id="content">
		<section class="products">
			<div class="container">
				<div class="row">
					<div class="col-xs-12">
						<h3 class="products__ttl">Продукция</h3>
					</div>
				</div>
				<div class="row">
					<div class="col-md-3 visible-md visible-lg">
						<form class="filter">
							<h4 class="filter__ttl">Производитель</h4>
							<label class="filter__radio">
								<input type="checkbox" name="">
								<div class="checkbox__text">Нутранекст</div>
							</label>
							<label class="filter__radio">
								<input type="checkbox" name="">
								<div class="checkbox__text">ЛифГербз</div>
							</label>
							<h4 class="filter__ttl">Категории</h4>
							<label class="filter__radio">
								<input type="checkbox" name="">
								<div class="checkbox__text">Антистрес</div>
							</label>
							<label class="filter__radio">
								<input type="checkbox" name="">
								<div class="checkbox__text">Минеральные комплексы</div>
							</label>
							<label class="filter__radio">
								<input type="checkbox" name="">
								<div class="checkbox__text">Крепекий имуннитет</div>
							</label>
							<label class="filter__radio">
								<input type="checkbox" name="">
								<div class="checkbox__text">Женское здоровье</div>
							</label>
							<label class="filter__radio">
								<input type="checkbox" name="">
								<div class="checkbox__text">Мужское здоровье</div>
							</label>
							<label class="filter__radio">
								<input type="checkbox" name="">
								<div class="checkbox__text">Здоровое сердце</div>
							</label>
							<label class="filter__radio">
								<input type="checkbox" name="">
								<div class="checkbox__text">Гибкие суставы</div>
							</label>
							<label class="filter__radio">
								<input type="checkbox" name="">
								<div class="checkbox__text">Контроль веса</div>
							</label>
							<label class="filter__radio">
								<input type="checkbox" name="">
								<div class="checkbox__text">Чистое зрение</div>
							</label>
							<label class="filter__radio">
								<input type="checkbox" name="">
								<div class="checkbox__text">Здоровые почки</div>
							</label>
							<label class="filter__radio">
								<input type="checkbox" name="">
								<div class="checkbox__text">Кожа, волосы, ногти</div>
							</label>
							<label class="filter__radio">
								<input type="checkbox" name="">
								<div class="checkbox__text">Энергия</div>
							</label>
						</form>
					</div>
					<div class="col-md-9">
						<div class="col-sm-6">
							<div class="cart-item">
								<a href="cart.php"><img src="img/cart.jpg" alt="Вардхман Хелскейр" class="cart-item__img img-responsive"></a>
								<div class="cart-item__main">
									<h3 class="cart-item__name">Нутранекст</h3>
									<p class="cart-item__price">65 <span>грн</span></p>
								</div>
								<p class="cart-item__txt">Каждая представительница прекрасного пола хотела бы всегда оставаться привлекательной. Для этого на современном фармацевтическом рынке существует много препаратов, которые помогут сохранить красоту.</p>
								<div class="cart-item__main">
									<div class="cart-item__btnshow">
										<a href="basket.php">Подробнее</a>
									</div>
									<div class="cart-item__btn">
										<a href="basket.php">Добавить в корзину</a>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="col-sm-6">
							<div class="cart-item cart-item_last">
								<a href="cart.php"><img src="img/cart.jpg" alt="Вардхман Хелскейр" class="cart-item__img img-responsive"></a>
								<div class="cart-item__main">
									<h3 class="cart-item__name">Нутранекст</h3>
									<p class="cart-item__price">65 <span>грн</span></p>
